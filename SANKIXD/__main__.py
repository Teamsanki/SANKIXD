...
import config
from SANKIXD import LOGGER, app, userbot
from SANKIXD.core.call import SANKI
from SANKIXD.misc import sudo
from SANKIXD.plugins import ALL_MODULES
from SANKIXD.utils.database import get_banned_users, get_gbanned
...
async def init():
    ...
    for all_module in ALL_MODULES:
        importlib.import_module("SANKIXD.plugins" + all_module)
